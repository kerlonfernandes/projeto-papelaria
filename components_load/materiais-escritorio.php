...
<style>
  ...
  <div class="limit">
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicatorsEscritorio" data-bs-slide="prev">
      <span class="carousel-control-prev-icon buttons-caroussel" aria-hidden="true"></span>
      <span class="visually-hidden">Previous</span>
    </button>
      <div id="carouselExampleIndicatorsEscritorio" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators" style="pointer-events: none;">
          <?php foreach ($grupos_produtos as $index => $grupo) : ?>
            <button type="button" data-bs-target="#carouselExampleIndicatorsEscritorio" data-bs-slide-to="<?php echo $index; ?>" class="<?php echo $index === 0 ? 'active' : ''; ?>" aria-current="true" aria-label="Slide <?php echo $index + 1; ?>"></button>
          <?php endforeach; ?>
        </div>
    ...
    <div class="carousel-control-next mt-5" type="button" data-bs-target="#carouselExampleIndicatorsEscritorio" data-bs-slide="next">
